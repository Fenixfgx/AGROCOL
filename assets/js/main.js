...
(function($) {
    ...
    ================================ */
        ...
        $(window).scroll(function() {
            ...
            // Usar histéresis para evitar glitch en el punto de transición
            if (!isSticky && scrollTop > 260) {
                isSticky = true;
                $("#header-sticky").addClass("sticky");
                $(".header-top-section").addClass("hidden");
                $(".header-main").addClass("has-logo");
            } else if (isSticky && scrollTop < 240) {
                isSticky = false;
                $("#header-sticky").removeClass("sticky");
                $(".header-top-section").removeClass("hidden");
                $(".header-main").removeClass("has-logo");
            }
